...
! Former revisions:
! -----------------
! $Id: virtual_flight_mod.f90 3065 2018-06-12 07:03:02Z Giersch $
! IF statement revised to consider new vertical grid stretching
! 
! 3049 2018-05-29 13:52:36Z Giersch
! Error messages revised
! 
! 2932 2018-03-26 09:39:22Z Giersch
! renamed flight_par to virtual_flight_parameters
! 
...
! read_restart_data_mod, virtual_flight_prerun flag has been removed, redundant
! skipping function has been removed, flight_read/write_restart_data 
! have been renamed to flight_r/wrd_global, flight_rrd_global is called in 
! read_restart_data_mod now, marker *** end flight *** was removed, strings and
! their respective lengths are written out and read now in case of restart runs
! to get rid of prescribed character lengths, CASE DEFAULT was added if restart
! data is read
! 
! 2872 2018-03-12 10:05:47Z Giersch
! virutal_flight_prerun flag is used to define if module 
...
! Definition of a new function called flight_skip_var_list to skip module 
! parameters during reading restart data
! 
! 2563 2017-10-19 15:36:10Z Giersch
! flight_read_restart_data is called in flight_parin in the case of a restart 
! run. flight_skip_var_list is not necessary anymore due to marker changes in
! restart files.
! 
...
!
!--    Read namelist
       READ ( 11, virtual_flight_parameters )
!
