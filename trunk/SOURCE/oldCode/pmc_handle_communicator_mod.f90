...
! Former revisions:
! -----------------
! $Id: pmc_handle_communicator_mod.f90 2932 2018-03-26 09:39:22Z maronga $
...
! Bugfix, give Intent(inout) attributes in routine reading nestpar-namelist (MS)
! 
! 2599 2017-11-01 13:18:45Z hellstea
! Separate peer communicator peer_comm introduced for MPI_INTERCOMM_CREATE.
! Some cleanup and commenting improvements. 
! 
...
! in order to assure that further namelists are also found.
! 
! 2279 2017-06-12 15:23:44Z suehring
