...
! Bugfixes:
!   - preset te_diss and te_e to avoid runtime errors
!   - implementation of buoyancy term to dissipation
!     according to Sogachev et al. (2012)
!   - where diss_p < 0 set diss_p = 0.1 diss
!   - calculate progn eq(diss) starting from nzb+1
! Changes:
!   - add sig_e to TKE equation
!   - adjust prognostic equation of diss
!   - set model constants according to Koblitz (2013)
!   - renamed c_m to c_0
...
! Corrected min/max values of Rif.
!
